...
繁中：這是一個以教學內容為主的 Astro 學習網站，整理多條技術主線：React、Spring Boot、Maven、MySQL、Go、Rust、C#、Next.js、TypeScript、PostgreSQL、SQLite。

English: This is a content-first Astro learning site for multiple teaching tracks: React, Spring Boot, Maven, MySQL, Go, Rust, C#, Next.js, TypeScript, PostgreSQL, and SQLite.
...
- Lesson library pages and single-lesson pages for React, Spring Boot, Maven, MySQL, Go, Rust, C#, Next.js, TypeScript, PostgreSQL, and SQLite
...
- 繁中路由在 `/zh`
- 目前主題線都有獨立課程首頁
- React、Spring Boot、Maven、MySQL、Go、Rust、C#、Next.js、TypeScript、PostgreSQL、SQLite 都有 lessons 列表頁與單課頁
- Header 內建語言切換
...
- `src/data/lessonRegistry.ts` - shared registry for generic data-backed tracks (Go, Rust, C#, Next.js, TypeScript, PostgreSQL, SQLite, Maven)
...
- `src/data/lessonRegistry.ts` - Go、Rust、C#、Next.js、TypeScript、PostgreSQL、SQLite、Maven 共用的 data-backed 課程 registry
...
- React, Maven, MySQL, Go, Rust, C#, Next.js, TypeScript, PostgreSQL, and SQLite lesson data are split into English and Chinese sources.
- Go, Rust, C#, Next.js, TypeScript, PostgreSQL, SQLite, and Maven use the shared data-backed lesson registry and dynamic lesson routes.
...
- React、Maven、MySQL、Go、Rust、C#、Next.js、TypeScript、PostgreSQL、SQLite 已拆成英中兩套資料來源。
- Go、Rust、C#、Next.js、TypeScript、PostgreSQL、SQLite、Maven 透過共用的 data-backed lesson registry 與動態 lessons 路由產生頁面。
