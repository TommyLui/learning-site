...
export const courses: Course[] = [
  ...
  },
  {
    ...
    zhCategory: '後端開發',
    accent: '#6AA05A',
    subtitle: 'Build backend APIs with Spring Boot 4.x, Java 17+, Spring Framework 7, Hibernate 7, Spring Security 7, and production-ready practices.',
    zhSubtitle: '用 Spring Boot 4.x、Java 17+、Spring Framework 7、Hibernate 7 與 Spring Security 7 建立後端 API。',
    overview:
      'This course follows a Spring Boot 4.x learning path with Spring Framework 7, modular starters, Jakarta-based APIs, REST design, data access, testing, security, observability, and deployment-focused practices.',
    zhOverview: '這套課程以 Spring Boot 4.x 為主線，串起 Spring Framework 7、模組化 starters、Jakarta API、REST 設計、資料存取、測試、安全性、可觀測性與部署實務。',
    level: 'Beginner to intermediate',
    zhLevel: '初階到中階',
    totalLessons: 21,
    focus: ['Java 17+ and Spring Boot 4.x', 'Spring MVC with modular starters', 'Spring Data JPA + Hibernate 7', 'Jackson 3 and Jakarta validation', 'Spring Security 7'],
    zhFocus: ['Java 17+ 與 Spring Boot 4.x', '使用模組化 starters 的 Spring MVC', 'Spring Data JPA + Hibernate 7', 'Jackson 3 與 Jakarta Validation', 'Spring Security 7'],
    ...
    outcomes: [
      'Understand the Spring Boot 4.x application model, Java 17+ baseline, Spring Framework 7 alignment, and startup flow',
      'Build layered REST APIs with Jackson 3, Jakarta validation, focused tests, and clear boundaries',
      'Connect Spring Boot 4.x to MySQL with Hibernate 7 and secure APIs with Spring Security 7 patterns',
    ],
    zhOutcomes: [
      '理解 Spring Boot 4.x 的應用模型、Java 17+ 基線、Spring Framework 7 對齊與啟動流程',
      '用 Jackson 3、Jakarta Validation、聚焦測試與清楚分層建立 REST API',
      '把 Spring Boot 4.x 透過 Hibernate 7 接上 MySQL，並用 Spring Security 7 模式保護 API',
    ],
    modules: [
      {
        title: 'Module 1 · Spring Boot 4.x foundations and setup',
        zhTitle: '模組 1 · Spring Boot 4.x 基礎與建置',
        description: 'Learn what Spring Boot 4.x solves, why Java 17+ still matters, and how the Spring Framework 7 generation starts.',
        zhDescription: '了解 Spring Boot 4.x 解決什麼問題、為什麼 Java 17+ 仍然重要，以及 Spring Framework 7 世代如何啟動。',
        lessons: [
          {
            number: 'Lesson 1',
            title: 'What Spring Boot 4.x is and why it matters',
            summary: 'Understand how Spring Boot 4.x simplifies backend development while aligning with Java 17+, Spring Framework 7, and current Jakarta APIs.',
          },
          {
            number: 'Lesson 2',
            title: 'Create a Boot 4 project with Spring Initializr',
            summary: 'Generate a clean starter project, choose a compatible Java version, and select the new focused starter families deliberately.',
          },
          {
            number: 'Lesson 3',
            title: 'Understand project structure, startup, and embedded servers',
            summary: 'Read the generated project, run the app, and connect the main entry class to Boot 4 startup, Servlet 6.1, and Tomcat 11 defaults.',
          },
        ],
      },
      {
        title: 'Module 2 · Core application model',
        zhTitle: '模組 2 · 核心應用模型',
        description: 'Build a strong mental model for beans, configuration, profiles, and Boot 4 modular auto-configuration.',
        zhDescription: '建立對 beans、設定、profiles 與 Boot 4 模組化自動設定的心智模型。',
        lessons: [
          {
            number: 'Lesson 4',
          ...
          {
            number: 'Lesson 5',
            title: 'Configuration files, profiles, and type-safe settings',
            summary: 'Use configuration properties, environment values, and profiles to manage different runtime setups without hardcoding environment details.',
          },
          {
            number: 'Lesson 6',
            title: 'Auto-configuration and Boot 4 modular starters',
            summary: 'See how conditional auto-configuration and focused starters reduce boilerplate while still allowing customization.',
          },
        ],
      },
      {
        title: 'Module 3 · Build REST APIs with Spring MVC and Jackson 3',
        zhTitle: '模組 3 · 用 Spring MVC 與 Jackson 3 建 REST API',
        description: 'Create HTTP endpoints, structure request and response models, and keep the web layer clean in the Boot 4 web stack.',
        zhDescription: '在 Boot 4 web stack 中建立 HTTP endpoints、整理 request/response model，並保持 web layer 乾淨。',
        lessons: [
          {
            number: 'Lesson 7',
            title: 'Build your first REST controller with Spring MVC',
            summary: 'Create a simple controller and map HTTP requests to backend logic using the Spring MVC starter path.',
          },
          {
            number: 'Lesson 8',
            title: 'Handle requests, responses, and JSON with Jackson 3',
            summary: 'Work with request parameters, request bodies, DTOs, and JSON responses while knowing what changed in the Jackson 3 generation.',
          },
          {
            number: 'Lesson 9',
      ...
      },
      {
        ...
        description: 'Connect the app to MySQL and use Jakarta Persistence, Hibernate 7, and Spring Data JPA for CRUD flows.',
        zhDescription: '把 app 接上 MySQL，並用 Jakarta Persistence、Hibernate 7 與 Spring Data JPA 建立 CRUD flow。',
        lessons: [
          {
            number: 'Lesson 10',
            title: 'Connect Spring Boot 4.x to MySQL and Hibernate 7',
            summary: 'Configure the datasource, MySQL driver, and key JPA/Hibernate 7 settings for reliable relational data access.',
          },
          {
            number: 'Lesson 11',
            title: 'Entities, repositories, transactions, and JPA basics',
            summary: 'Map domain objects with Jakarta Persistence annotations, use repositories, and understand where transactions enter the persistence flow.',
          },
          {
            number: 'Lesson 12',
      ...
      },
      {
        ...
        zhTitle: '模組 5 · 測試與除錯',
        description: 'Improve reliability with focused tests, Boot 4 test starters, integration coverage, and practical debugging habits.',
        zhDescription: '用聚焦測試、Boot 4 test starters、整合驗證與實用除錯習慣提升可靠性。',
        lessons: [
          {
            number: 'Lesson 13',
            title: 'Write unit tests and focused Spring tests',
            summary: 'Test business rules in isolation and choose focused Spring test slices when framework behavior matters.',
          },
          {
            number: 'Lesson 14',
            title: 'Write Boot 4 integration tests for web and persistence',
            summary: 'Verify web and persistence behavior with MockMvc, RestTestClient, repository tests, Testcontainers, and the relevant Boot 4 test starters.',
          },
          {
            number: 'Lesson 15',
            title: 'Common debugging patterns in Boot 4 applications',
            summary: 'Learn how to inspect logs, read condition reports, trace request flow, and diagnose configuration and data issues.',
          },
        ],
      },
      {
        title: 'Module 6 · Security and authentication with Spring Security 7',
        zhTitle: '模組 6 · 安全性與驗證',
        description: 'Add authentication and authorization with Spring Security 7 and modern filter-chain configuration.',
        zhDescription: '用 Spring Security 7 與現代 filter-chain 設定加入 authentication / authorization。',
        lessons: [
          {
            number: 'Lesson 16',
            title: 'Spring Security 7 fundamentals',
            summary: 'Understand the security filter chain, authentication, authorization, and SecurityFilterChain-based configuration in the Boot 4 generation.',
          },
          {
            number: 'Lesson 17',
          ...
          {
            number: 'Lesson 18',
            title: 'Session, JWT, resource-server, and authorization-server basics',
            summary: 'Compare session-based auth with JWT-based APIs and understand where resource server and the integrated authorization-server story fit.',
          },
        ],
      },
      {
        title: 'Module 7 · Packaging, observability, and deployment',
        zhTitle: '模組 7 · 封裝、可觀測性與部署',
        description: 'Prepare the application for production with executable jars, Actuator, readiness/liveness probes, OpenTelemetry positioning, Docker-friendly packaging, and AOT awareness.',
        zhDescription: '用 executable jar、Actuator、readiness/liveness probes、OpenTelemetry 定位、Docker 友善封裝與 AOT 意識把 app 準備到 production。',
        lessons: [
          {
            number: 'Lesson 19',
            title: 'Build executable jars and container-friendly artifacts',
            summary: 'Build an executable artifact and understand Boot 4 packaging, layered extraction with jarmode tools, and container-friendly delivery workflows.',
          },
          {
            number: 'Lesson 20',
            title: 'Use Actuator for health, probes, metrics, and observability',
            summary: 'Expose health, info, metrics, readiness/liveness groups, and observability signals with Spring Boot Actuator and Micrometer.',
          },
          {
            number: 'Lesson 21',
            title: 'Prepare Spring Boot 4.x for deployment and migration',
            summary: 'Review externalized configuration, Docker, AOT/native-image positioning, and the safest path for teams moving from the previous major line to Boot 4.',
          },
        ],
      },
    ],
...
export const recentLessons: RecentLesson[] = [
  ...
  },
  {
    ...
    number: 'Lesson 10',
    title: 'Connect Spring Boot 4.x to MySQL and Hibernate 7',
    summary: 'Configure the datasource and prepare the project for relational data access with MySQL and Hibernate 7.',
    updatedAt: 'Updated Apr 2026',
  ...
  },
  {
    ...
    number: 'Lesson 16',
    title: 'Spring Security 7 fundamentals',
    summary: 'Understand authentication, authorization, and SecurityFilterChain-based API protection in Spring Boot 4.x apps.',
    updatedAt: 'Updated Apr 2026',
